            ...
            <div class="row">
                <div class="col-lg-12">
                    <div
                        ...
                        <div class="ht-email d-none d-lg-inline-block">
                            <a href="mailto:{{$config->email}}">{{$config->email}}</a>
                        </div>
                        <div class="ht-promo d-none d-md-inline-block">
                            {{-- <a href="#"><span><i class="bi bi-tags"></i></span> Hosting Friday Sale:
                                Starting at
                        ...
                        <div class="ht-links">
                            ...
                            <a href="{{route('index')}}">
                                <span>
                                    <img src="{{Auth::user()->avatar}}" alt="avatar" width="25" height="25" style="border-radius: 50%;" loading="lazy">
                                </span>
                                {{Auth::user()->name}}
                            </a>
                            @else
                            <a href="{{route('front.login-client')}}"><span><i class="bi bi-person-plus"></i></span> Đăng nhập</a>
                            @endif
                        </div>
                    </div>
                </div>
