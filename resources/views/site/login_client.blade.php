                            ...
                            <form id="login_client">
                                <div class="mb-20">
                                    <div class="input-box mail">
                                        <span><img src="/site/images/message-bold.svg" alt="icon" loading="lazy"></span>
                                ...
                                <div class="mb-20">
                                    <div class="input-box pass">
                                        <span><img src="/site/images/lock-bold.svg" alt="icon" loading="lazy"></span>
        ...
        <div class="container">
            <div class="form__wrapper__bg">
                <div class="row align-items-center">
                        ...
                        <form id="customer_register">
                            ...
                            <div class="mb-20">
                                <div class="input-box phone">
                                    <span><img src="/site/images/call-bold.svg" alt="icon" loading="lazy"></span>
                            ...
                            <div class="mb-20">
                                ...
                                <span class="invalid-feedback d-block error" style="text-align: left;" role="alert"
                                    ng-if="errors && errors['password_confirmation']">
                    ...
                    <div class="col-lg-6">
                        <div class="signup__right__content mb-30">
                            <img class="w-100" src="/site/images/signup-ilus-1.svg" alt="ilustration" loading="lazy">
                        </div>
                    </div>
                </div>
            </div>
